<template>
  <div class="bot"> 
    ...
    <el-form :model="form" label-width="120px">
      <el-form-item label="考试名称:" style="margin-left: 60px;padding: 10px 0px;">
    ...
    <el-form-item label="试题存入题库:">
      <el-select v-model="form.region" placeholder="请选择题库" style="margin-left: 10px;">
  ...
  <div class="box">
    ...
    <div class="examss">
        ...
        <el-radio-group v-model="radio" style="margin-top: 5px;margin-left: 10px;">
  ...
  <span class="bu">不填表示永久</span>
    ...
    <el-radio :label="15">考试结束后查看</el-radio>
      ...
      <div class="examss">
        ...
        <el-checkbox-group v-model="checkList" style="margin-top: 10px;margin-left: 10px;">
